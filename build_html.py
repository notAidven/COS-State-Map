...
<div class="container">
  <header>
    ...
    <span class="subtitle">The objective of this report is to create a comprehensive
    state-by-state documentation of policies related to community solar (CS) and
    community-owned solar (COS).</span>
  </header>
